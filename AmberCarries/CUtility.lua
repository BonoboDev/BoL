...
local reloadRequire = false
local isHere = SCRIPT_PATH.."/Common/AmberCarries/CUtility.lua"
function CheckUpdate()
    local ToUpdate = {}
    
    ToUpdate.Version = 0.2
    
    ToUpdate.Name = "CUtility"
    
    ToUpdate.Host = "raw.githubusercontent.com"
    
    ToUpdate.VersionPath = "/AMBER17/BoL/master/AmberCarries/CUtility.version"
    
    ToUpdate.ScriptPath =  "/AMBER17/BoL/master/AmberCarries/CUtility.lua"
    
    ToUpdate.SavePath = isHere
    
    ToUpdate.CallbackUpdate = function(NewVersion,OldVersion) print("<font color=\"#F62459\"><b>[" .. ToUpdate.Name .. "] AutoUpdater - </font> <font color=\"#E08283\">Updated to "..NewVersion..". Please Reload with 2x F9</b></font>") reloadRequire = true end
    
    ToUpdate.CallbackNoUpdate = function() print("<font color=\"#F62459\"><b>[" .. ToUpdate.Name .. "] AutoUpdater - </font> <font color=\"#E08283\">No Updates Found</b></font>") end
...
function CUtility:__init()
	if reloadRequire then return end
	print("<font color=\"#F62459\"><b>[AmberCarries] - Utility</font><font color=\"#E08283\"> is successfuly loaded </b></font>")

	self.buffTable = { 5, 29, 22, 8, 11, 21, 25 }
	
	self.itemTable = {
		Sabre = "BilgewaterCutlass",
		Bortk = "ItemSwordOfFeastAndFamine",
		Clean = { First = "ItemMercurial", Second = "QuicksilverSash" },
		Youmus = "YoumusBlade",
		wardTrinket = { First = "TrinketTotemLvl1", Second = "TrinketTotemLvl3", Third = "TrinketTotemLvl4" },
		visionTrinket = { First = "TrinketOrbLvl1", Second = "TrinketOrbLvl3" }
	}

	self.GabCloserList = {
		a = { charName = "Akali", spellName = "AkaliShadowDance"},
		b = { charName = "Alistar", spellName = "Headbutt"},
		c = { charName = "Diana", spellName = "DianaTeleport"},
		d = { charName = "Irelia", spellName = "IreliaGatotsu"},
		e = { charName = "Jax", spellName = "JaxLeapStrike"},
		f = { charName = "Jayce", spellName = "JayceToTheSkies"},
		g = { charName = "Maokai", spellName = "MaokaiUnstableGrowth"},
		h = { charName = "MonkeyKing", spellName = "MonkeyKingNimbus"},
		i = { charName = "Pantheon", spellName = "Pantheon_LeapBash"},
		j = { charName = "Poppy", spellName = "PoppyHeroicCharge"},
		k = { charName = "Quinn", spellName = "QuinnE"},
		l = { charName = "XinZhao", spellName = "XenZhaoSweep"},
		m = { charName = "LeeSin", spellName = "blindmonkqtwo"},
		n = { charName = "Aatrox", spellName = "AatroxQ"},
		o = { charName = "Gragas", spellName = "GragasE"},
		p = { charName = "Graves", spellName = "GravesMove"},
		q = { charName = "Hecarim", spellName = "HecarimUlt"},
		r = { charName = "JarvanIV", spellName = "JarvanIVDragonStrike"},
		s = { charName = "JarvanIV", spellName = "JarvanIVCataclysm"},
		t = { charName = "Khazix", spellName = "KhazixE"},
		u = { charName = "Khazix", spellName = "khazixelong"},
		x = { charName = "Leblanc", spellName = "LeblancSlide"},
		y = { charName = "Leblanc", spellName = "LeblancSlideM"},
		z = { charName = "Leona", spellName = "LeonaZenithBlade"},
		aa = { charName = "Malphite", spellName = "UFSlash"},
		ab = { charName = "Renekton", spellName = "RenektonSliceAndDice"},
		ac = { charName = "Sejuani", spellName = "SejuaniArcticAssault"},
		ad = { charName = "Shen", spellName = "ShenShadowDash"},
		ae = { charName = "Tristana", spellName = "RocketJump"},
		af = { charName = "Tryndamere", spellName = "slashCast"}
		}

	self.InteruptionSpells = {
		a = { charName = "FiddleSticks", spellName = "Crowstorm"},
		b = { charName = "MissFortune", spellName = "MissFortuneBulletTime"},
		c = { charName = "Nunu", spellName = "AbsoluteZero"},
		d = { charName = "Caitlyn", spellName = "CaitlynAceintheHole"},
		e = { charName = "Katarina", spellName = "KatarinaR"},
		f = { charName = "Karthus", spellName = "FallenOne"},
		g = { charName = "Malzahar", spellName = "AlZaharNetherGrasp"},
		h = { charName = "Galio", spellName = "GalioIdolOfDurand"},
		i = { charName = "Darius", spellName = "DariusExecute"},
		j = { charName = "MonkeyKing", spellName = "MonkeyKingSpinToWin"},
		k = { charName = "Vi", spellName = "ViR"},
		l = { charName = "Shen", spellName = "ShenStandUnited"},
		m = { charName = "Urgot", spellName = "UrgotSwap2"},
		n = { charName = "Lucian", spellName = "LucianR"},
		o = { charName = "Braum", spellName = "BraumR"},
		p = { charName = "Tristana", spellName = "TristanaW"},
		q = { charName = "Corki", spellName = "CarpetBomb"}
		}

	self.orbwalkerArray = {
		SACR   = { Loaded = false, Message = "SAC:R" },
		MMA    = { Loaded = false, Message = "MMA" },
		Pewalk = { Loaded = false, Message = "Pewalk"},
		SX	   = { Loaded = false, Message = "SX" }
	}

	self.Range = myHero.range + myHero.boundingRadius

	self.TargetSelector = TargetSelector(TARGET_LESS_CAST_PRIORITY, self.Range, DAMAGE_PHYSICAL, false, true)

	if _G.Reborn_Loaded ~= nil then
		self.orbwalkerArray.SACR.Loaded = true
	elseif (_G.MMA_Loaded or _G.MMA_IsLoaded) then
		self.orbwalkerArray.MMA.Loaded = true
	elseif _Pewalk ~= nil then
		self.orbwalkerArray.Pewalk.Loaded = true
	else
		self.orbwalkerArray.SX.Loaded = true
		require "SxOrbWalk"
	end

	self:Menu()
	AddTickCallback(function() self:OnTick() end)
	AddUpdateBuffCallback(function(unit,buff,stack)  self:UpdateBuffItem(unit,buff,stack) end )
end

function CUtility:Menu()
	self.Settings = scriptConfig("AmberCarries - Utility", "AmberCarriesUtility")
	
	self.Settings:addSubMenu("Orbwalker Settings", "Orbwalker")
	local message = self:GetOrbwalkerInfo()
	if message == "SX" then
		_G.SxOrb:LoadToMenu(self.Settings.Orbwalker)
	else		
		self.Settings.Orbwalker:addParam("info", "Orbwalker:", SCRIPT_PARAM_INFO, message)
	end

	self.Settings:addSubMenu("["..myHero.charName.."] -  Item Settings", "item")
	self.Settings.item:addParam("Sabre", "Use Bilgewater Cutlass", SCRIPT_PARAM_ONOFF, true)
	self.Settings.item:addParam("Bortk", "Use BORTK", SCRIPT_PARAM_ONOFF, true)
	self.Settings.item:addParam("Youmus", "Use Youmus", SCRIPT_PARAM_ONOFF, true)
	self.Settings.item:addParam("info", "", SCRIPT_PARAM_INFO, "")
	self.Settings.item:addParam("Quicksilver", "Use Quicksilver Sash", SCRIPT_PARAM_ONOFF, true)
	self.Settings.item:addParam("Mercurial", "Use Mercurial Scimitar", SCRIPT_PARAM_ONOFF, true)
	self.Settings.item:addParam("humanizer", "Humanizer Delay (ms)", SCRIPT_PARAM_SLICE, 0, 0, 300, 0)	
end

--[[###############################################]]
--[[ Callback + OnTick Function ]]

function CUtility:OnTick()
	self.TargetSelector:update()
	self:UpdateRange()
end

function CUtility:UpdateRange()
	local target = self:GetOrbwalkerTarget()
	if not target then
		self.Range = myHero.range + myHero.boundingRadius
	else
		self.Range = myHero.range + myHero.boundingRadius + target.boundingRadius
	end
end
...
function CUtility:DrawCircleNextLvl(x, y, z, radius, width, color, chordlength)
...
function CUtility:round(num) 

	if num >= 0 then return math.floor(num+.5) else return math.ceil(num-.5) end
end

function CUtility:DrawCircle2(x, y, z, radius, color)
...
function CUtility:DrawLineHPBar(damage, text, unit, enemyteam)
...
function CUtility:GetHPBarPos(enemy)
...
function CUtility:GetOrbwalkerInfo()
	for uid, orbwalker in pairs(self.orbwalkerArray) do
		if orbwalker.Loaded then return orbwalker.Message end
	end
	return "No Orbwalker Load"
end

function CUtility:GetOrbwalkerTarget()
	if self.orbwalkerArray.SACR.Loaded and _G.AutoCarry ~= nil then
		return _G.AutoCarry.Crosshair:GetTarget()
	elseif self.orbwalkerArray.MMA.Loaded then
		return _G.MMA_Target()
	elseif self.orbwalkerArray.Pewalk.Loaded then
		return _Pewalk.GetTarget()
	elseif self.orbwalkerArray.SX.Loaded then
...
function CUtility:ForceAttack(target)
	if not ValidTarget(target) then return end

	if self.orbwalkerArray.SACR.Loaded and _G.AutoCarry ~= nil then
		_G.AutoCarry.Orbwalker:Orbwalk(target)
	elseif self.orbwalkerArray.MMA.Loaded and GetDistance(target) <= _G.MMA_GetRange() then
		_G.MMA_ForceTarget(target)
	elseif self.orbwalkerArray.Pewalk.Loaded then
		_Pewalk.ForceTarget(target)
	elseif self.orbwalkerArray.SX.Loaded then
		_G.SxOrb:ForceTarget(target)
	end
end

function CUtility:DisableAttack()
	if self.orbwalkerArray.SACR.Loaded and _G.AutoCarry ~= nil then
...
function CUtility:EnableAttack()
	if self.orbwalkerArray.SACR.Loaded and _G.AutoCarry ~= nil then
...
function CUtility:CreateSpellTarget(range, dmgType)
	self.TargetSelectorTable[#self.TargetSelectorTable+1] = TargetSelector(TARGET_LESS_CAST_PRIORITY, range, dmgType, false, true)
	return self.TargetSelectorTable[#self.TargetSelectorTable]
end

function CUtility:UseAntiGabCloser(spell)
	if spell.name and self.GabCloserList and self.GabCloserList[spell.name] ~= nil then
		if spell.target ~= nil and spell.target == myHero then
			return true
		elseif spell.endPos ~= nil then		
			if GetDistance(spell.endPos) < myHero.boundingRadius then return true end
		end
	end
end

function CUtility:UseInterruptSpell(spell, unit)
	if spell.name and self.InteruptionSpells and self.InteruptionSpells[spell.name] ~= nil then
		if GetDistance(unit) <= self.Range then return true end
	end
end
...
function CUtility:isUnderTurret(pos, enemyTurret)
...
function CUtility:CountAllyHeroInRange(range)
	local number = 0
	range = range or 2000
...
function CUtility:CountEnemyHeroInRange(range)
	local number = 0
	range = range or 2000
	for i, unit in pairs(GetEnemyHeroes()) do
		if unit and ValidTarget(unit) and GetDistance(unit) <= range then
			number = number + 1
		end
	end
	return number
...
function CUtility:GetAlly()
	for i = 1, heroManager.iCount do
		local hero = heroManager:GetHero(i)
		if hero and hero.valid and hero.visible and not hero.dead and hero.team == myHero.team and hero.charName ~= myHero.charName then
			if GetDistance(hero) <= 2000 then
				return hero
			end
		end
	end	
...
function CUtility:UpdateBuffItem(unit,buff,stack)
	if buff and unit and unit.isMe then
		if table.contains(self.buffTable, buff.type) or buff.name == "summonerexhaust" then
			for uid, item in pairs(self.itemTable.Clean) do
				local gotIt, slot = self:GotItemSlot(item)
				if (self.Settings.item.Quicksilver and item =="QuicksilverSash") or (self.Settings.item.Mercurial and item == "ItemMercurial") then
					if gotIt then 
						DelayAction(function() 
							CastSpell(slot)
						end, self.Settings.item.humanizer/1000)
					end
				end
			end
		end
...
function CUtility:GotItemSlot(name)
	for slot = 6, 12 do
		if myHero:GetSpellData(slot).name == name then return true,slot end
	end	
	return false
end

function CUtility:CastItem(unit,isActive)
	if not isActive then return end
	if ValidTarget(unit) then
		if self.Settings.item.Sabre then
			if ((myHero.health * 100) / myHero.maxHealth ) > 80 then return end
			local gotIt, slot = self:GotItemSlot(self.itemTable.Sabre)
			if gotIt and GetDistance(unit) <= 550 then CastSpell(slot, unit) end
		end
		if self.Settings.item.Bortk then
			if ((myHero.health * 100) / myHero.maxHealth ) > 80 then return end
			local gotIt, slot = self:GotItemSlot(self.itemTable.Bortk)
			if gotIt and GetDistance(unit) <= 550 then CastSpell(slot, unit) end
		end
		if self.Settings.item.Youmus then
			local gotIt, slot = self:GotItemSlot(self.itemTable.Youmus)
			if gotIt and GetDistance(unit) <= 600 then CastSpell(slot) end
		end
	end
end
...
function VPrediction:__init()
    ...
    if not _G.VPredictionMenu then
        _G.VPredictionMenu = scriptConfig("AmberCarries - VPrediction", "VPrediction")
